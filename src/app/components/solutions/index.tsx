...
export default function Solutions() {
  return (
    <div className=" bg-black py-20 flex flex-col justify-center items-center">
      <section className="max-w-7xl px-8">
        ...
        <div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-white">
            ...
            <div className="text-center">
              ...
              <p className="text-xl mt-4 text-white">
                Encontre consultores que atendam às suas necessidades
                especificas
              </p>
            </div>
